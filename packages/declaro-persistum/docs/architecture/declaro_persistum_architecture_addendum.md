...
>
> **Its examples hand a `ConnectionPool` to the consumer**, which is forbidden. They also call `ConnectionPool.libsql(...)`, which no longer exists — libsql was removed from declaro-persistum in favour of pyturso.
>
