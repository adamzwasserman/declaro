...
class TestTursoDialect:
    ...
    def test_array_reindex_sql_sqlite_vs_postgresql(self):
        ...
        # "libsql" is gone from this comparison: the word is abolished, and an
        # unrecognised dialect now raises rather than quietly returning the
        # PostgreSQL form. test_dialect_sql_is_not_guessed asserts that.
