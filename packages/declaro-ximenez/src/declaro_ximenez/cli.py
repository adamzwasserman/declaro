"""Command-line interface for declaro-ximenez."""
...
from .types import XimenezConfig, Violation
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="ximenez",
        description="Nobody expects the Ximénez Inquisition! Type enforcement for Python.",
    )
...
def run_checks(
    ...
    """Run ximenez checks on a list of files.
...
def collect_files(paths: list[str], config: XimenezConfig) -> list[Path]:
